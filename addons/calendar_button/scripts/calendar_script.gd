...
func setup_calendar_icon():
	var normal_texture := create_button_texture("res://addons/calendar_button/btn_img/btn_32x32_03.png")
	set_normal_texture(normal_texture)

	var pressed_texture := create_button_texture("res://addons/calendar_button/btn_img/btn_32x32_04.png")
